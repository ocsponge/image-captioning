...
def parse_opt():
    ...
    model_group.add_argument('-vocab-size', metavar='', type=int, default=9812, help='size of vocabulary')
    ...
    train_group.add_argument('-max-epochs', metavar='', type=int, default=50, help='number of epochs')
    train_group.add_argument('-batch-size', metavar='', type=int, default=1024, help='batch size')
    ...
    train_group.add_argument('-log-steps', metavar='', type=int, default=100, help='number of steps after which training info will be printed')
    ...
    pred_group.add_argument('-model', metavar='', type=int, default=50, help='the order number of saved models to predict')
